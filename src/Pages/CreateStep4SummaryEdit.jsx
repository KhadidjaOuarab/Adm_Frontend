            ...
            <table className="atatable-crud-demo customers m-4 pr-4">
              ...
              <tbody className=" mb-4">
                <tr>
                  ...
                  <td>{ele.issueCity ? ele.issueCity : ""}</td>
                </tr>
              </tbody>
              <thead>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td>{ele.agentCodeExchange ? ele.agentCodeExchange : ""}</td>
              ...
              <tbody>
                <tr>
                  ...
                  <td>{ele.agentCodeRefund ? ele.agentCodeRefund : ""}</td>
              ...
              <tbody>
                <tr>
                  ...
                  <td>{ele.currencyCode ? ele.currencyCode : ""}</td>
